                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 fs-4">Entrar em Sua Conta</h5>
                                    <p class="text-center small">Forneça seu nome de usuário e senha para entrar</p>
                                </div>
                                ...
                                <form method="post" class="row g-3 needs-validation" action="{{route('admin_authenticate')}}" novalidate>
                                    ...
                                    <div class="col-12">
                                        @if(empty(request()->query('redirect-after-login')))
                                        <p class="small mb-0">Não tem uma conta? <a href="{{route('admin_create_account')}}">Criar Conta</a></p>
                                        @else
                                        <p class="small mb-0">Não tem uma conta? <a href="{{route('admin_create_account', ['redirect-after-login' => request()->query('redirect-after-login')])}}">Criar Conta</a></p>
                                        @endif
                                    </div>
                                </form>
